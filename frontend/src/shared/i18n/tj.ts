...
export const t = {
  ...
  analytics: {
    ...
    inventoryTitle: 'Таҳлили анбор',
    inventorySubtitle: 'Ҳолати ҷории захираҳо',
    positions: 'Номгӯи молҳо',
    unitsTotal: 'Ҳамагӣ адад',
    inventoryCost: 'Арзиши захираҳо',
    potentialRevenue: 'Даромади имконпазир',
    potentialProfit: 'Фоидаи имконпазир',
    lowStockCount: 'Кам мондааст',
    outOfStockCount: 'Тамом шудааст',
    topByValue: 'Молҳои гаронтарин дар захира',
    noProblems: 'Ҳама мол кофист',
    shownFirst: 'Нишон дода шуд',
